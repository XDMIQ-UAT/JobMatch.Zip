...
export default function XDMIQAssessmentPage() {
  ...
  return (
    <>
      <Banner anonymousId={userId || null} showProfile={false} />
      <main style={{ 
        padding: '2rem', 
        maxWidth: '800px', 
        margin: '0 auto',
        ...
        <h1 style={{ color: 'var(--auth-text, #333)' }}>XDMIQ AI-Native Credentialing</h1>
        <p style={{ color: 'var(--auth-text-secondary, #666)' }}>Assessment based on your preferences and reasoning</p>
